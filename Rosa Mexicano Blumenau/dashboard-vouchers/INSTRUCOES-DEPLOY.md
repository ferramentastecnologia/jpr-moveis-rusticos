# 🚀 Instruções de Deploy - Rosa Mexicano Vouchers
...
- **Repositório:** https://github.com/ferramentastecnologia/rosa-mexicano-vouchers
- **Status:** ✅ Ativo

### Backend (Railway)
- **URL:** https://rosa-mexicano-vouchers-production.up.railway.app
- **Repositório:** https://github.com/ferramentastecnologia/rosa-mexicano-vouchers
...
### ✅ Já Configuradas:
```
APP_URL=https://rosa-mexicano-vouchers-production.up.railway.app
...
3. Build e deploy automático
4. URL: https://rosa-mexicano-vouchers-production.up.railway.app
...
### 2. Webhook do Asaas
- Asaas notifica: `https://rosa-mexicano-vouchers-production.up.railway.app/api/webhook`
...
- ✅ Mensagem formatada
- ✅ Código do voucher
- ✅ Link para download: `https://rosa-mexicano-vouchers-production.up.railway.app/api/download-pdf?code=RM-XXX`
...
### Formato da URL:
```
https://rosa-mexicano-vouchers-production.up.railway.app/api/download-pdf?code=CODIGO_DO_VOUCHER
```

### Exemplo:
```
https://rosa-mexicano-vouchers-production.up.railway.app/api/download-pdf?code=RM-ABC123-XYZ789
```
...
### Health Check
```
GET https://rosa-mexicano-vouchers-production.up.railway.app/health
```

### Download de PDF
```
GET https://rosa-mexicano-vouchers-production.up.railway.app/api/download-pdf?code=CODIGO
```

### Webhook Asaas
```
POST https://rosa-mexicano-vouchers-production.up.railway.app/api/webhook
```

### Criar Pagamento
```
POST https://rosa-mexicano-vouchers-production.up.railway.app/api/create-payment
```

### Listar Vouchers
```
GET https://rosa-mexicano-vouchers-production.up.railway.app/api/vouchers
```

### Validar Voucher
```
POST https://rosa-mexicano-vouchers-production.up.railway.app/api/validate-voucher
Body: { "code": "RM-XXX" }
```
...
```bash
curl https://rosa-mexicano-vouchers-production.up.railway.app/health
```
...
```bash
curl https://rosa-mexicano-vouchers-production.up.railway.app/api/test-pdf
```

### 3. Testar Download de PDF
Após gerar um PDF de teste, acesse:
```
https://rosa-mexicano-vouchers-production.up.railway.app/api/download-pdf?code=CODIGO_GERADO
```
...
2. **Criar Novo Webhook:**
   - Nome: `Rosa Mexicano Vouchers`
   - URL: `https://rosa-mexicano-vouchers-production.up.railway.app/api/webhook`
...
```
https://rosa-mexicano-vouchers-production.up.railway.app/health
```
