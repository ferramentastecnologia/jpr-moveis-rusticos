...
### Backend (Railway):
```
https://rosa-mexicano-vouchers-production.up.railway.app
```
- ✅ API de vouchers
- ✅ Geração de PDF
...
### Repositórios GitHub:
- Backend: https://github.com/ferramentastecnologia/rosa-mexicano-vouchers
- WAHA: https://github.com/ferramentastecnologia/waha-rosa-mexicano
...
5. Asaas processa e envia webhook para:
   https://rosa-mexicano-vouchers-production.up.railway.app/api/webhook
   ↓
...
### 2. Testar WAHA:
```bash
curl -s https://waha-rosa-mexicano-production.up.railway.app/api/sessions \
...
```bash
curl https://rosa-mexicano-vouchers-production.up.railway.app/api/vouchers
```
...
```bash
# 1. Parar sessão
curl -X POST https://waha-rosa-mexicano-production.up.railway.app/api/sessions/default/stop \
  -H "X-Api-Key: rosa_mexicano_waha_2024"

# 2. Iniciar sessão
curl -X POST https://waha-rosa-mexicano-production.up.railway.app/api/sessions/default/start \
  -H "X-Api-Key: rosa_mexicano_waha_2024"

# 3. Gerar QR Code
curl -X GET https://waha-rosa-mexicano-production.up.railway.app/api/default/auth/qr \
  -H "X-Api-Key: rosa_mexicano_waha_2024" \
  -H "Accept: image/png" \
  --output waha-qr.png
```
...
2. URL deve ser: https://rosa-mexicano-vouchers-production.up.railway.app/api/webhook
