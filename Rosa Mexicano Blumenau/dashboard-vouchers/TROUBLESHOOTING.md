# 🔧 TROUBLESHOOTING - Rosa Mexicano Vouchers
...
2. Clique no serviço: **rosa-mexicano-vouchers**
3. Vá em: **Variables**
...
```bash
curl -X POST https://rosa-mexicano-vouchers-production.up.railway.app/api/create-payment \
...
### Sintoma:
```
Access to fetch at 'https://rosa-mexicano-vouchers...' from origin 'https://rosamexicanovouchers.netlify.app' has been blocked by CORS policy
```
...
3. **Testar manualmente:**
   ```bash
   curl https://rosa-mexicano-vouchers-production.up.railway.app/api/test-email
   ```
