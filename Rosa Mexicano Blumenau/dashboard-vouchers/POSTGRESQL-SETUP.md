...
2. Entre no projeto **rosa-mexicano-vouchers**
...
1. Clique no serviço **rosa-mexicano-vouchers** (Node.js)
2. Vá na aba **"Variables"**
...
2. Acesse: https://rosa-mexicano-vouchers-production.up.railway.app/health
