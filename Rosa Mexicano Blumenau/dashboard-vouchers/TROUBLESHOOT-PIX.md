...
1. Clique em `rosa-mexicano-vouchers` (Node.js)
2. Vá em **"Variables"**
...
2. Clique em `rosa-mexicano-vouchers` no Railway
...
2. **Resposta da API:**
   ```javascript
   // Copie no console:
   fetch('https://rosa-mexicano-vouchers-production.up.railway.app/api/pix-qrcode/pay_xxx')
     .then(r => r.json())
