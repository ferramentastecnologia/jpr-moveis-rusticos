# 🚀 GUIA COMPLETO DE DEPLOY - Sistema de Vouchers Rosa Mexicano
...
5. **Configure Root Directory:**
   ...
   - Defina: `rosa-mexicano-dashboard`
...
8. **Gere um domínio:**
   ...
   - **COPIE A URL** que aparecer (ex: `https://rosa-mexicano-vouchers-production.up.railway.app`)
...
1. Abra: `/Users/juanminni/meu-repositorio/rosa-mexicano-dashboard/checkout-simples.html`
...
2. **Arraste a pasta `rosa-mexicano-dashboard` inteira** de novo
