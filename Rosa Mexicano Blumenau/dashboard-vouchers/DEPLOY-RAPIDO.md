...
**`vouchers-rosa-mexicano.html`** ← Este arquivo único!
...
4. **Arraste** o arquivo `vouchers-rosa-mexicano.html` para a área
5. **Pronto!** Você terá uma URL tipo: `https://rosa-mexicano-vouchers.netlify.app`
...
3. **Faça upload** de `vouchers-rosa-mexicano.html`
4. **Acesse:** `https://rosamexicanoblumenau.com.br/vouchers-rosa-mexicano.html`

### Via GitHub (se usar)

```bash
git add vouchers-rosa-mexicano.html
...
No arquivo `vouchers-rosa-mexicano.html`, procure por:
