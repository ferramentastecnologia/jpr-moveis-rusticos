...
async function testPDFGeneration() {
    ...
    return new Promise(async (resolve, reject) => {
        try {
            ...
            doc.fontSize(28).font('Helvetica-Bold').text('Rosa Mexicano', 50, 120, { align: 'center' });
...
async function testEmailSending(transporter, pdfPath, voucherData) {
    ...
    try {
        const mailOptions = {
            from: `"Rosa Mexicano - TESTE" <${CONFIG.EMAIL_USER}>`,
            to: CONFIG.EMAIL_USER, // Envia para você mesmo
            subject: `🧪 TESTE - Voucher Rosa Mexicano - ${voucherData.code}`,
            html: `
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                    ...
                    <div style="text-align: center; padding: 20px; color: #666; font-size: 12px;">
                        <p>© 2024 Rosa Mexicano Blumenau - Sistema de Vouchers</p>
                    </div>
                </div>
            `,
            attachments: [
...
async function runAllTests() {
    ...
    log('┃     Rosa Mexicano Blumenau                       ┃', 'bright');
    log('┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛\n', 'bright');
