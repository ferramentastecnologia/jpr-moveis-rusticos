  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Alpha OKR</h1>
      ...
      <main className="max-w-7xl mx-auto p-6 space-y-6">
        {/* Welcome Banner */}
        <div className="bg-gradient-to-r from-primary-600 via-purple-600 to-pink-600 rounded-2xl p-8 text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-lg opacity-90">Você está 15% acima da média do time este trimestre. Continue assim!</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-blue-500 hover:shadow-xl transition-shadow">
            <div className="flex justify-between items-start mb-4">
              <div>
                <p className="text-sm font-semibold text-gray-600 mb-1">OKRs Ativos</p>
            ...
            <div className="flex items-center text-sm">
              <span className="text-green-600 font-semibold">↑ 2 novos</span>
          ...
          <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-green-500 hover:shadow-xl transition-shadow">
            <div className="flex justify-between items-start mb-4">
              <div>
                <p className="text-sm font-semibold text-gray-600 mb-1">Progresso Geral</p>
                <h3 className="text-4xl font-bold text-green-600">78%</h3>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-purple-500 hover:shadow-xl transition-shadow">
            <div className="flex justify-between items-start mb-4">
              <div>
                <p className="text-sm font-semibold text-gray-600 mb-1">PDI Completo</p>
                <h3 className="text-4xl font-bold text-purple-600">65%</h3>
              </div>
            ...
            <div className="flex items-center text-sm">
              <span className="text-purple-600 font-semibold">8/12 itens</span>
              <span className="text-gray-400 ml-2">concluídos</span>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-orange-500 hover:shadow-xl transition-shadow">
            <div className="flex justify-between items-start mb-4">
              <div>
                <p className="text-sm font-semibold text-gray-600 mb-1">Medalhas</p>
                <h3 className="text-4xl font-bold text-orange-600">247</h3>
              </div>
            ...
            <div className="flex items-center text-sm">
              <span className="text-orange-600 font-semibold">🏆 Top 5%</span>
              <span className="text-gray-400 ml-2">da empresa</span>
            </div>
          </div>
        </div>
              ...
              <div className="border-2 border-gray-100 rounded-xl p-5 hover:border-primary-200 transition-colors">
                <div className="flex items-start justify-between mb-3">
                  <div className="flex-1">
                    ...
                    <h4 className="font-bold text-gray-900 mb-2">Aumentar a produtividade da equipe</h4>
                  </div>
                ...
                <div className="space-y-3 mt-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2 flex-1">
                      ...
                      <p className="text-sm text-gray-700">Reduzir tempo de reuniões em 30%</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2 flex-1">
                      ...
                      <p className="text-sm text-gray-700">Implementar 5 automações</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2 flex-1">
                      ...
                      <p className="text-sm text-gray-700">Aumentar NPS da equipe para 8.5</p>
                    </div>
              ...
              <div className="border-2 border-gray-100 rounded-xl p-5 hover:border-primary-200 transition-colors">
                <div className="flex items-start justify-between mb-3">
                  <div className="flex-1">
                    ...
                    <h4 className="font-bold text-gray-900 mb-2">Desenvolver habilidades de liderança</h4>
                  </div>
                  <div className="text-right">
                ...
                <div className="space-y-3 mt-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2 flex-1">
                      ...
                      <p className="text-sm text-gray-700">Completar curso de gestão</p>
                    </div>
                    <span className="text-sm font-bold text-green-600">100%</span>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2 flex-1">
                      ...
                      <p className="text-sm text-gray-700">Mentorar 3 colaboradores</p>
                    </div>
                    <span className="text-sm font-bold text-yellow-600">67%</span>
                  </div>

                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2 flex-1">
                      <div className="w-5 h-5 rounded-full border-2 border-gray-300"></div>
                      <p className="text-sm text-gray-700">Liderar projeto cross-funcional</p>
                    </div>
              ...
              <div className="border-2 border-gray-100 rounded-xl p-5 hover:border-primary-200 transition-colors">
                <div className="flex items-start justify-between mb-3">
                  <div className="flex-1">
                    ...
                    <h4 className="font-bold text-gray-900 mb-2">Melhorar qualidade das entregas</h4>
                  </div>
                  <div className="text-right">
                ...
                <div className="space-y-3 mt-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2 flex-1">
                      ...
                      <p className="text-sm text-gray-700">Reduzir bugs em 40%</p>
                    </div>
                    <span className="text-sm font-bold text-green-600">100%</span>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2 flex-1">
                      ...
                      <p className="text-sm text-gray-700">Aumentar cobertura de testes para 85%</p>
                    </div>
                    <span className="text-sm font-bold text-green-600">100%</span>
                  </div>
                </div>
